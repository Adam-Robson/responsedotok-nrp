 ...
 *   - the upstream server,
 *   - the target path
 *  @property {function} [onRequest] - Called prior ro proxying the request. Returns false to cancel request.
 *  @property {function} [onResponse] - Called after receiving the response is received from upstream.
